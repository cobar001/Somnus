//
//  WelcomePageTwoViewController.swift
//  Somnus
//
...
class WelcomePageTwoViewController: UIViewController {
	...
	fileprivate let mImageView: UIImageView = {
		let view: UIImageView = UIImageView(image: UIImage(named: "SomnusOnBoardingPage2"))
